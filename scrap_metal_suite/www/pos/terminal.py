...
# Assets this page hand-links via plain <link>/<script> tags, relative to the
# app's public/ dir. Kept in sync with the tags in terminal.html.
_LINKED_ASSETS = (
    "css/pos.css",
...
def get_context(context):
    ...
    context.asset_v = get_asset_version()
