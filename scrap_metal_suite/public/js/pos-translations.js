...
const POS_I18N = (function() {
    ...
    const translations = {
        en: {
            ...
            confirmReweight: 'Confirm Reweight',
            reweightReasonRequired: 'A reweigh reason is required',
            dropoffCompleted: 'Drop-off completed',
            failedToSaveRemarks: 'Could not save the remarks',
            photos: 'Photos',
            ...
            cannotSort: 'Cannot sort this container',
            noRecentSorting: 'No sorting slip to reprint yet',
            sortedEarlier: 'sorted earlier',
            promptReopenSortingReason: 'Reason to reopen this sorting:',
            sortingReopened: 'Sorting reopened — {0} cancelled',
            alreadyFullySorted: 'Container {0} has already been fully sorted ({1} kg). Sorting it again ADDS to what is recorded. Continue?',
            containerNotActive: 'Container {0} is {1}. It was written off during receiving and is not available for sorting.',
        ...
        th: {
            ...
            supplier: 'ผู้ขาย',
            customer: 'ลูกค้า',
            confirmWeight: 'ยืนยันน้ำหนัก',
            confirmReweight: 'ยืนยันการชั่งซ้ำ',
            reweightReasonRequired: 'ต้องระบุเหตุผลในการชั่งซ้ำ',
            dropoffCompleted: 'ปิดใบส่งของเรียบร้อย',
            failedToSaveRemarks: 'บันทึกหมายเหตุไม่สำเร็จ',
            photos: 'รูปภาพ',
            ...
            refresh: 'รีเฟรช',
            containers: 'ถุงบรรจุ',
            cannotSort: 'ไม่สามารถคัดแยกถุงนี้ได้',
            noRecentSorting: 'ยังไม่มีใบคัดแยกให้พิมพ์ซ้ำ',
            sortedEarlier: 'คัดแยกไปแล้ว',
            promptReopenSortingReason: 'เหตุผลในการเปิดการคัดแยกใหม่:',
            sortingReopened: 'เปิดการคัดแยกใหม่แล้ว — ยกเลิก {0}',
            alreadyFullySorted: 'ถุง {0} ถูกคัดแยกครบแล้ว ({1} กก.) หากคัดแยกซ้ำ ระบบจะบวกเพิ่มจากของเดิม ต้องการดำเนินการต่อหรือไม่?',
            containerNotActive: 'ถุง {0} มีสถานะ {1} ถูกยกเลิกตั้งแต่ตอนรับเข้า จึงไม่สามารถนำมาคัดแยกได้',
